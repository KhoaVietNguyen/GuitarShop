...
<body>
	...
	<div class="m-3 pl-5 pr-5">
		<header class="font-weight-bold font-italic text-center ml-5 mr-5 p-3"
			...
			Insert</header>
		<div class="ml-5 mr-5 pl-5 pr-5 pt-3 pb-3" id="nav-modal">
			<form:form action="main/insert.htm" modelAttribute="gtr"
				method="post" enctype="multipart/form-data"
				class="ml-5 mr-5 pl-5 pr-5 " style="font-size: 20px">
				...
				<div class="form-group">
					...
					<form:textarea class="form-control" path="Details" rows="3" />
				</div>
				<div class="font-weight-bold text-right"
					style="font-size: 15px; color: #0073e6">${message}</div>
				<div class="custom-file">

					<input type="file" class="custom-file-input " id="customFile"
						name="img" accept="image/png, image/jpeg"> <label
						class="custom-file-label font-weight-bold" for="customFile">No
						file chosen</label>
				</div>
				<div id="nav-modal" class="mt-4 mb-3">
					<button type="button" class="btn btn-block font-weight-bold "
						...
						data-target="#exampleModal">Insert</button>
								...
								<div class="p-3">
									<h5 class="text-center">
										<strong
											...
											you sure to insert this product ?</strong>
									</h5>
								</div>
